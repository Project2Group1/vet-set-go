...
var element = document.querySelector("#birthday-contact");
if (element) {
  ...
  try {
    ...
    try {
      vaccinated = document.querySelector(
        'input[name="vaccinations-newPet"]:checked'
      ).value;
    } catch {
      vaccinated = "";
    }
    ...
    try {
      isNeuteredOrSpayed = document.querySelector(
        'input[name="isNeuteredOrSpayed-newPet"]:checked'
      ).value;
    } catch {
      isNeuteredOrSpayed = "";
    }
